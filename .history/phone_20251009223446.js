 ...
 * Ex.: { url: 'https://meuservidor/arquivo.pdf', filename: 'lista.pdf' }
 */
 ...
 * Se for um link YouTube/Vimeo, prefira mandar como texto (o index.js já trata isso).
 */
...
async function sendDocument({ token, phoneNumberId, to, url, filename }) {
  const body = {
    ...
    to,
    type: 'document',
    document: { link: url, filename: filename || 'arquivo.pdf' }
  };
...
// no final do arquivo, garanta que está exportando tudo:
module.exports = {
  sendText,
  sendButtons,
  sendDocument,
